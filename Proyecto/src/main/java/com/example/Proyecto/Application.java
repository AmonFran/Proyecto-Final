...
public class Application {
	...
	CommandLineRunner initData(ProductoService productoService, CategoriaService categoriaService,
		...
		return args -> {
			...
			productoService
					.añadir(new Producto(0L, "Mochila verde", 24D, 1L, "../images/viejas/mochilaVerde.jpg", mochilas));
			productoService.añadir(new Producto(0L, "Bolso rojo", 50D, 5L, "../images/viejas/bolsoRojo.jpg", bolsos));
			productoService
					.añadir(new Producto(0L, "Bandolera azul", 12D, 3L, "../images/viejas/sacoAzul.jpg", bandoleras));
			productoService
					.añadir(new Producto(0L, "Cortina estampada", 100D, 9L, "../images/viejas/cortinaEstampada.jpg",
							cortinas));
			...
			usuarioService
					.añadir(new Usuario(null, "Manager1", "Manager1", "Manager1", "1234", "Manager1", Rol.MANAGER));
		};
	}
}
